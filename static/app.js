...
function updateNav() {
    ...
    if (state.user) {
        ...
        const departmentLabel = { DEV: '개발', MEDICAL: '의료', RESEARCH: '연구' }[state.user.department] || state.user.department;
        ...
        authLink.innerHTML = `
            <span class="user-info" onclick="navigate('/my-page')" style="cursor: pointer;">${state.user.name}(${departmentLabel})</span>
